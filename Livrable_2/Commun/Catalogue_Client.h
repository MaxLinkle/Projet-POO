...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->TTCremise->Text = L"Total TTC apr�s remise : ";
...
#pragma endregion
	...
	private: System::Void acheter_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			MessageBox::Show("Vous ne pouvez pas demander des quantit�es n�gatives ", "Info", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
		else
		{
			this->Hide();
